 ...
 */
public class PointSecretShare {
    private BlsPoint shareY;
    private BigInteger shareX;



    public PointSecretShare(BigInteger shareX, BlsPoint shareY) {
        this.shareX = shareX;
        this.shareY = shareY;
    }
    ...
    public void updateY(BlsPoint y) {
        this.shareY = y;
    }
...
//     */
//    public static PointSecretShare fromBytes(byte[] from) {
//        int offset = 0;
...
//
//        return new PointSecretShare(shareX, shareY);
//    }

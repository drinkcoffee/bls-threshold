...
public class Bn254Fq2PointWrapper implements BlsPoint {
    ECP2 point;

    Bn254Fq2PointWrapper(ECP2 point) {
        this.point = point;
    ...
    public BlsPoint negate() {
        ...
        this.point.copy(p);
        p.neg();
        return new Bn254Fq2PointWrapper(p);
    }
    ...
    public static Bn254Fq2PointWrapper load(byte[] data) {
        ...
        Bn254Fq2PointWrapper w = new Bn254Fq2PointWrapper(point);
    ...
    public boolean equals(Object obj) {
        ...
        return  this.point.equals(((Bn254Fq2PointWrapper) obj).point);
    }

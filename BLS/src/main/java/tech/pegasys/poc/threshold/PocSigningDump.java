...
//    static byte[] DATA = new byte[]{0x01, 0x02, 0x03, 0x04};
    static byte[] DATA = new byte[]{0x01};
    ...
    boolean thresholdVerify2(byte[] toBeVerified, BlsPoint signature) {
        return this.nodes[COORDINATING_NODE].verify2(toBeVerified, signature);

    }

    BlsPoint getPublicKey() {
        return this.nodes[0].getPublicKey();
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        PocSigningDump test = new PocSigningDump();
        test.initNodes();
        ...
        boolean verified2 = test.thresholdVerify2(DATA, signature);
        System.out.println("Signature verified2: " + verified2);


        BlsPoint pubKey = test.getPublicKey();

        BytesValue zeros = BytesValue.wrap(new byte[]{0x0, 0x0, 0x0, 0x0});
        System.out.println(" Zeros: " + zeros.toString());
        BytesValue data = BytesValue.wrap(DATA);
        System.out.println(" Data: " + data.toString());
        BytesValue pubKeyBytes = BytesValue.wrap(pubKey.store());
        System.out.println(" PubKey: " + pubKeyBytes.toString());
        BytesValue sigBytes = BytesValue.wrap(signature.store());
        System.out.println(" Signature: " + sigBytes.toString());
